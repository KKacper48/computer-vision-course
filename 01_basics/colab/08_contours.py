...
img_cnt = cv2.drawContours(image=img.copy(), contours=[contours[11]], contourIdx=-1, color=(0, 255, 0), thickness=2)
...
print(f'[INFO] Idneks konturu o największym polu: {idx_flag_area}\n Pole: {max_area}')
